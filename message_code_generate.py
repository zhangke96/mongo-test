...
MESSAGE_NAME = "MongoQueryRequest"
MESSAGE_FIELDS = (("required", "std::string", "database"),
                  ("required", "std::string", "collection"),
                  ("optional", "BsonPtr", "query"),
                  ("optional", "BsonPtr", "sort"),
                  ("optional", "int32_t", "skip"),
                  ("optional", "int32_t", "limit"),
                  ("repeated", "std::string", "fields"))
...
# MESSAGE_NAME = "MongoCountResponse"
# MESSAGE_FIELDS = (("optional", "int32_t", "number"),)

# MESSAGE_NAME = "MongoInsertRequest"
# MESSAGE_FIELDS = (("required", "std::string", "database"),
#                   ("required", "std::string", "collection"),
#                   ("optional", "bool", "ordered"),
#                   ("repeated", "BsonPtr", "documents"))
TRIVAL_TYPE = ("int64_t", "uint64_t", "int32_t", "uint32_t", "bool")

# MESSAGE_NAME = "MongoDeleteRequest"
# MESSAGE_FIELDS = (("required", "std::string", "database"),
#                   ("required", "std::string", "collection"),
#                   ("optional", "bool", "ordered"),
#                   ("optional", "BsonPtr", "query"),
#                   ("optional", "bool", "delete_many"))

# MESSAGE_NAME = "MongoDeleteResponse"
# MESSAGE_FIELDS = (("required", "std::string", "database"),)

# MESSAGE_NAME = "MongoUpdateRequest"
# MESSAGE_FIELDS = (("required", "std::string", "database"),
#                    ("required", "std::string", "collection"),
#                    ("required", "BsonPtr", "selector"),
#                    ("required", "BsonPtr", "update"),
#                    ("optional", "bool", "ordered"),
#                    ("optional", "bool", "upsert"),
#                    ("optional", "bool", "multi"))

# MESSAGE_NAME = "MongoUpdateResponse"
# MESSAGE_FIELDS = (("optional", "int32_t", "matched_number"),
#                   ("optional", "int32_t", "modified_number"),
#                   ("repeated", "UpsertedDoc", "upserted_docs"),
#                   ("repeated", "WriteError", "write_errors"))
